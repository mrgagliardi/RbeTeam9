...
private:
    ...
    String serialString;
public:
    HRUltrasonic(void);  //ideally, this would take pins as parameters, but just hard-coded for now since we only have one
    void init(void);
    ...
    void checkPin(uint8_t checkPingTimer);
...
extern HRUltrasonic hrUltrasonic; 
