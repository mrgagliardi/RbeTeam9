...
/*
 * Datasheet: https://www.IRSensor.com/documents/LV-MaxSonar-EZ_Datasheet.pdf
 */
...
private:
    ...
    String serialString;
public:
    IRSensor(void);  //ideally, this would take pins as parameters, but just hard-coded for now since we only have one
    void init(void);
